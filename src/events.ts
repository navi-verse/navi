...
export type NvEvent = ImmediateEvent | OneShotEvent | PeriodicEvent;
...
export class EventsWatcher {
	...
	private parseEvent(content: string, filename: string): NvEvent | null {
	...
	private execute(filename: string, event: NvEvent, deleteAfter: boolean = true): void {
...
export function createEventsWatcher(workspaceDir: string, bot: WhatsAppBot): EventsWatcher {
